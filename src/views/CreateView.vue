  ...
  <section class="about">
    <div class="container">
      <div class="header flex items-center justify-between mt-14 mb-5">
        <h1 class="text-[40px]">Create page</h1>
      ...
      <div v-if="sent" class="w-[550px] mx-auto rounded-md shadow-lg flex flex-col items-center justify-center gap-5 p-5 py-10 ">
        <h1 class="font-mono text-xl">Product has been created</h1>
        <TheButton @click="$router.push({ name: 'home' })">
          Go Home
          <i class="fa-solid fa-house"></i>
        </TheButton>
      ...
      <form @submit.prevent v-else
        ...
        <button class="w-full py-3 px-5 text-white bg-purple-800" @click="createProduct">Create</button>
      </form>
